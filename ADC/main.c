...
/* USER CODE BEGIN PV */
uint16_t sg1_numb, sg2_numb, sg3_numb, sg4_numb;
uint16_t display = 1, number = 0;
...
void disp_select()
{
	sg1_numb = number/1000;
	sg2_numb = (number/100) % 10;
    sg3_numb = (number / 10) % 10;
    sg4_numb = number % 10;
